...
#'
#' @export
Select_normal=function(Obj_filtered=NULL, raw_counts=NULL, cell_nclust=5 ){
...
tmp=pheatmap::pheatmap(theta_hat_cbn2, cluster_cols = F, cluster_rows = T, show_rownames = F, clustering_method = "ward.D2", gaps_col=gaps_col)#, annotation_row = cell_label, annotation_col =region_label)
dev.off()
